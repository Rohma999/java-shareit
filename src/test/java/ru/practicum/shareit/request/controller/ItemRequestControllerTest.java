...
class ItemRequestControllerTest {
    ...
    @Test
    void createItemRequestWhenEmptyDescriptionStatus400() throws Exception {
        RequestItemRequestDto addItemRequestDto = RequestItemRequestDto.builder().description("").build();
        Long userId = 1L;
    ...
    @Test
    void getItemRequestWhenWrongRequestIdThenStatus400() throws Exception {
        Long requestId = -1L;
        Long userId = 1L;
    ...
    @Test
    void getItemRequestWhenWrongRequesterIdThenStatus400() throws Exception {
        Long requestId = 1L;
        Long userId = -1L;
        LocalDateTime created = LocalDateTime.now();
